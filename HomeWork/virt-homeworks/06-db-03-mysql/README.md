...
a7284fa16b46   mysql:8.0   "docker-entrypoint.s…"   2 minutes ago   Up 2 minutes   0.0.0.0:3306->3306/tcp, 33060/tcp   mysql-docker
$ docker exec -it mysql-docker bash
root@a7284fa16b46:/# mysql -u root -p test_db < /tmp/test_dump.sql
Enter password:
root@a7284fa16b46:/#
```
...
```bash
root@a7284fa16b46:/# mysql -u root -p
Enter password: 
...
```bash
root@a7284fa16b46:/# cat /etc/mysql/my.cnf
