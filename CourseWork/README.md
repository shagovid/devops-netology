...
Мой сервер находится в облаке, я добавил себе на локальную машину с Windows 7 соответствие test.example.com в файл hosts и добавил себе скаченный с помощью WinSCP корневой сертификат в доверенные
![img.png](img.png)
Сертификат
![img_1.png](img_1.png)
Сайт в браузере
